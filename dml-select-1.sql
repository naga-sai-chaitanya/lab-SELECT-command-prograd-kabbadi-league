...
INSERT INTO TEAM VALUES(1,'ABC','XYZ',2,3);
INSERT INTO TEAM VALUES(2,'BCD','PQR',4,5);
INSERT INTO TEAM VALUES(3,'LMN','RST',9,7);
...
SELECT * FROM PLAYER;
INSERT INTO PLAYER VALUES(5,'SAI','INDIA',10,20);
INSERT INTO PLAYER VALUES(10,'CHAIANYA','JAPAN',7,9);
INSERT INTO PLAYER VALUES(5,'SAITAN','SOUTH AFRICA',8,208);
INSERT INTO PLAYER VALUES(5,'NAGA','INDIA',3,1);
...
SELECT NAME FROM PLAYERS WHERE COUNTRY='INDIA' OR COUNTRY='IRAN' AND  ORDER BY NAME ASC;
SELECT * FROM PLAYERS;
...
SELECT * FROM PLAYER WHERE COUNTRY!='INDIA' AND COUNTRY!='IRAN' ORDER BY NAME ASC;
...
INSERT INTO VENUE VALUES(2,'LORDS',6);
INSERT INTO VENUE VALUES(3,'CHINNA SWAMY',7);
INSERT INTO VENUE VALUES(4,'GACHIBOWLI',8);
...
WHERE ID IN(SELECT WINNER_TEAM_ID FROM OUTCOME WHERE ID IN(SELECT ID FROM GAME WHERE GAME_DATE='05/JUN/2020'))ORDER BY NAME ASC;
...
SELECT NAME FROM PLAYER
WHERE ID IN(SELECT PLAYER_OF_MATCH FROM OUTCOME WHERE ID IN(SELECT ID FROM GAME WHERE GAME_DATE='19/AUG/2020'))ORDER BY ID DESC;
